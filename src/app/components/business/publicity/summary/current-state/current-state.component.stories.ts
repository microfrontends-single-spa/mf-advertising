...
const TITULO = `CURRENT-STATE`;

const SUMMARY = `
    El componente <strong>CURRENT-STATE</strong> presenta el estado actual de la publicidad para el envío de la misma por whatsapp, en el se definen las siguientes <strong>propiedades</strong>:`;
...
export default {
    title: 'Components-Business/Publicity/Summary/CurrentState',
