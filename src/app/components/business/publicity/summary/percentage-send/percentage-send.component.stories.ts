...
import { PercentageSendComponent } from './percentage-send.component';
...
const TITULO = `PERCENTAGE-SEND`;

const SUMMARY = `
    El componente <strong>PERCENTAGE-SEND</strong> presenta información porcentual de cada estado del envío de publicidad por whatsapp, en él se definen las siguientes <strong>propiedades</strong>:`;
...
<div style="min-width: 450px;">
    <percentage-send></percentage-send>
</div>`;
...
export default {
    title: 'Components-Business/Publicity/Summary/PercentageSend',
    component: PercentageSendComponent,
    decorators: [
        moduleMetadata({
            declarations: [],
            imports: [
