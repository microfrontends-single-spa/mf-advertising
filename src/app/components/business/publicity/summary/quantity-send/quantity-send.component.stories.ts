...
import { QuantitySendComponent } from './quantity-send.component';
...
const TITULO = `QUANTITY-SEND`;

const SUMMARY = `
    El componente <strong>QUANTITY-SEND</strong> presenta información discreta de cada estado del envío de publicidad por whatsapp, en él se definen las siguientes <strong>propiedades</strong>:`;
...
export default {
    title: 'Components-Business/Publicity/Summary/QuantitySend',
    component: QuantitySendComponent,
    decorators: [
        moduleMetadata({
            declarations: [],
            imports: [
