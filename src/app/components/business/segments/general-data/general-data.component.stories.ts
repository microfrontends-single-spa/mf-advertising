...
const SUMMARY = `
    El componente <strong>GENERAL-DATA</strong> presenta información resumida sobre la configuración para el envío de publicidad, en el se definen las siguientes <strong>propiedades</strong>:`;
...
export default {
    title: 'Components-Business/Segments/GeneralData',
