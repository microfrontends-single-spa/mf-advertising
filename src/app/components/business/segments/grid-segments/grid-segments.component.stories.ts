...
import { GridSegmentsComponent } from './grid-segments.component';
...
const TITULO = `GRID-SEGMENTS`;

const SUMMARY = `
    El componente <strong>GRID-SEGMENTS</strong> presenta información de cada cliente en registro de una grilla según los filtros de segmentación, en el se definen las siguientes <strong>propiedades</strong>:`;
...
export default {
    title: 'Components-Business/Segments/GridSegments',
    component: GridSegmentsComponent,
    decorators: [
        moduleMetadata({
            declarations: [
