...
import { PercentageClientsComponent } from './percentage-clients.component';
...
const TITULO = `PERCENTAGE-CLIENTS`;

const SUMMARY = `
    El componente <strong>PERCENTAGE-CLIENTS</strong> presenta información en gráfica sobre la segmentación de clientes, en el se definen las siguientes <strong>propiedades</strong>:`;
...
<div style="width: 500px">
    <percentage-clients></percentage-clients>
</div>`;
...
export default {
    title: 'Components-Business/Segments/PercentageClients',
    component: PercentageClientsComponent,
    decorators: [
        moduleMetadata({
            declarations: [
